...
export function maskCNPJ(value: string, options: CNPJMaskOptions = {}): string { return applyDigitMask(ensureCNPJLength(value), options.pattern ?? DEFAULT_CNPJ_MASK_PATTERN); }
