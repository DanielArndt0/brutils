...
export function maskCEP(value: string, options: CEPMaskOptions = {}): string { return applyDigitMask(ensureCEPLength(value), options.pattern ?? DEFAULT_CEP_MASK_PATTERN); }
