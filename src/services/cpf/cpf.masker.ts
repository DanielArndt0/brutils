...
export function maskCPF(value: string, options: CPFMaskOptions = {}): string { return applyDigitMask(ensureCPFLength(value), options.pattern ?? DEFAULT_CPF_MASK_PATTERN); }
